...
// Use Replit backend URL instead of Mac IP
const API_BASE_URL = 'https://e2507793-01db-4a23-af7f-67f74c84824a-00-2d4tmxoczhs6p.janeway.replit.dev';
...
export default function App() {
  ...
  const testConnection = async () => {
    ...
    try {
      ...
      setUsers(data);
      setConnectionTest(`SUCCESS: Connected to Replit backend! Found ${data.length} users`);
      setError('');
        ...
        {users.length > 0 && (
          <View style={styles.section}>
            ...
            <Text style={styles.successMessage}>
              🎉 iOS Simulator successfully connected to NexGen Fitness backend!
            </Text>
          </View>
        )}
      </ScrollView>
