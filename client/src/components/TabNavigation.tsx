          ...
          {tabs.map((tab) => (
            ...
            >
              ...
              {tab.id === 'chat' && Number(unreadCount) > 0 && (
                <span className="absolute top-0 -right-1 bg-red-500 text-white text-xs rounded-full h-4 w-4 flex items-center justify-center min-w-[16px] font-bold text-[10px]">
