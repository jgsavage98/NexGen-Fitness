  ...
  return (
    <div className="min-h-screen bg-dark overflow-hidden">
      ...
      <div className="max-w-md mx-auto bg-dark min-h-screen flex flex-col relative">
        {/* Fixed Header */}
        <header className="fixed top-0 left-0 right-0 z-50 bg-surface/95 backdrop-blur-sm border-b border-gray-700">
          {/* Top safe area spacer */}
          <div className="bg-surface/95 backdrop-blur-sm safe-area-inset-top"></div>
